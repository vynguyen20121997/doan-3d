// Dán nội dung checkpoint2.html vào tab Google Docs đang mở.
//
// Cách hoạt động:
...
const HTML_PATH = process.env.HTML_PATH ||
  'file:///D:/UIT/ie402-chamcong-3d/scratch/checkpoint2.html';
...
async function main() {
  ...
  // Ctrl+End - nhay xuong cuoi tai lieu (GIU NGUYEN trang bia da co san)
  await dst.send('Input.dispatchKeyEvent', {
    type: 'rawKeyDown', modifiers: 2, windowsVirtualKeyCode: 35,
    key: 'End', code: 'End', commands: ['moveToEndOfDocument'],
  });
  await dst.send('Input.dispatchKeyEvent', {
    type: 'keyUp', modifiers: 2, windowsVirtualKeyCode: 35, key: 'End', code: 'End',
  });
  await sleep(1200);

  // Ctrl+Enter - ngat trang de phan ruot bat dau o trang moi
  await dst.send('Input.dispatchKeyEvent', {
